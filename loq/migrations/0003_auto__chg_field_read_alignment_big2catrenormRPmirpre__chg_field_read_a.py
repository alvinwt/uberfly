...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'loq_read_alignment', 'big2catrenormRPmirpre', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=15))

        # Changing field 'Read_alignment.normReads'
        db.alter_column(u'loq_read_alignment', 'normReads', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=15))

        # Changing field 'Read_alignment.AGO1IPoverTotalRNA'
        db.alter_column(u'loq_read_alignment', 'AGO1IPoverTotalRNA', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=15))

    def backwards(self, orm):

        # Changing field 'Read_alignment.big2catrenormRPmirpre'
        db.alter_column(u'loq_read_alignment', 'big2catrenormRPmirpre', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=15))

        # Changing field 'Read_alignment.normReads'
        db.alter_column(u'loq_read_alignment', 'normReads', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=15))

        # Changing field 'Read_alignment.AGO1IPoverTotalRNA'
        db.alter_column(u'loq_read_alignment', 'AGO1IPoverTotalRNA', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=15))
