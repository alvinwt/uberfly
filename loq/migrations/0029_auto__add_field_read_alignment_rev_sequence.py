...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read_alignment.rev_sequence'
        db.add_column(u'loq_read_alignment', 'rev_sequence',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Read_alignment.rev_sequence'
        db.delete_column(u'loq_read_alignment', 'rev_sequence')
