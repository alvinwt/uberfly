...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interval.sum_normReads'
        db.add_column(u'loq_interval', 'sum_normReads',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


        # Changing field 'Interval.all_reads_mapped'
        db.alter_column(u'loq_interval', 'all_reads_mapped', self.gf('django.db.models.fields.IntegerField')(max_length=10000, null=True))

    def backwards(self, orm):
        # Deleting field 'Interval.sum_normReads'
        db.delete_column(u'loq_interval', 'sum_normReads')


        # Changing field 'Interval.all_reads_mapped'
        db.alter_column(u'loq_interval', 'all_reads_mapped', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        u'loq.read_alignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intervalName': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['loq.Interval']"}),
