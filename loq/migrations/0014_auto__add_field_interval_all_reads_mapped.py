...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'loq_interval', 'all_reads_mapped',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1000, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'loq.interval': {
            ...
            'all_reads_mapped': ('django.db.models.fields.IntegerField', [], {'max_length': '1000', 'blank': 'True'}),
