...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interval.mid_point'
        db.add_column(u'loq_interval', 'mid_point',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=45, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interval.mid_point'
        db.delete_column(u'loq_interval', 'mid_point')
