...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interval.mapped_strand'
        db.add_column(u'loq_interval', 'mapped_strand',
                      self.gf('django.db.models.fields.CharField')(default='+', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interval.mapped_strand'
        db.delete_column(u'loq_interval', 'mapped_strand')
