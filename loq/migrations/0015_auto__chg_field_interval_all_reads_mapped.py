...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Interval.all_reads_mapped'
        db.alter_column(u'loq_interval', 'all_reads_mapped', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1000))
    ...
    models = {
        ...
        u'loq.interval': {
            ...
            'all_reads_mapped': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
