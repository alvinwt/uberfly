...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'loq_interval', (
            ...
            ('mirName', self.gf('django.db.models.fields.CharField')(default='', max_length=40)),
            ('NeatName', self.gf('django.db.models.fields.CharField')(default='0', max_length=100)),
            ('IntervalSize', self.gf('django.db.models.fields.IntegerField')(max_length=45, blank=True)),
            ('IntervalSerialNumber', self.gf('django.db.models.fields.SlugField')(max_length=45, null=True)),
        ...
        db.create_table(u'loq_read_alignment', (
            ...
            ('normReads', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('intervalName', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loq.Interval'])),
