...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Read_alignment.lib' to match new field type.
        db.rename_column(u'loq_read_alignment', 'lib', 'lib_id')
        # Changing field 'Read_alignment.lib'
        db.alter_column(u'loq_read_alignment', 'lib_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loq.Library']))
        # Adding index on 'Read_alignment', fields ['lib']
        db.create_index(u'loq_read_alignment', ['lib_id'])


    def backwards(self, orm):
        # Removing index on 'Read_alignment', fields ['lib']
        db.delete_index(u'loq_read_alignment', ['lib_id'])


        # Renaming column for 'Read_alignment.lib' to match new field type.
        db.rename_column(u'loq_read_alignment', 'lib_id', 'lib')
        # Changing field 'Read_alignment.lib'
        db.alter_column(u'loq_read_alignment', 'lib', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'loq.interval': {
            ...
            'all_reads_mapped': ('django.db.models.fields.IntegerField', [], {'max_length': '10000', 'null': 'True'}),
        ...
        u'loq.read_alignment': {
            ...
            'lib': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['loq.Library']"}),
