...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'loq_read_alignment', 'intervalName_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loq.Interval'], null=True))

    def backwards(self, orm):

        # Changing field 'Read_alignment.intervalName'
        db.alter_column(u'loq_read_alignment', 'intervalName_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['loq.Interval']))
