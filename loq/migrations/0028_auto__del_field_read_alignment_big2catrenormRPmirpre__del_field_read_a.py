...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'loq_read_alignment', 'big2catrenormRPmirpre')

        # Deleting field 'Read_alignment.AGO1IPoverTotalRNA'
        db.delete_column(u'loq_read_alignment', 'AGO1IPoverTotalRNA')

        # Adding field 'Read_alignment.library'
        db.add_column(u'loq_read_alignment', 'library',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['loq.Library']),
                      keep_default=False)

        # Adding field 'Library.total_mapped'
        db.add_column(u'loq_library', 'total_mapped',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, max_length=100, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'loq_read_alignment', 'big2catrenormRPmirpre',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=15),
                      keep_default=False)

        # Adding field 'Read_alignment.AGO1IPoverTotalRNA'
        db.add_column(u'loq_read_alignment', 'AGO1IPoverTotalRNA',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=15),
                      keep_default=False)

        # Deleting field 'Read_alignment.library'
        db.delete_column(u'loq_read_alignment', 'library_id')

        # Deleting field 'Library.total_mapped'
        db.delete_column(u'loq_library', 'total_mapped')
