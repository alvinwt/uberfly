...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'loq_read_alignment', 'intervalName',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['loq.Interval']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Read_alignment.intervalName'
        db.delete_column(u'loq_read_alignment', 'intervalName_id')
