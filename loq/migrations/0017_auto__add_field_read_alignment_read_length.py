...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read_alignment.read_length'
        db.add_column(u'loq_read_alignment', 'read_length',
                      self.gf('django.db.models.fields.IntegerField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Read_alignment.read_length'
        db.delete_column(u'loq_read_alignment', 'read_length')
