...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'loq_read_alignment', 'normReads', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=10))

    def backwards(self, orm):

        # Changing field 'Read_alignment.normReads'
        db.alter_column(u'loq_read_alignment', 'normReads', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        u'loq.read_alignment': {
            ...
            'normReads': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '10'}),
