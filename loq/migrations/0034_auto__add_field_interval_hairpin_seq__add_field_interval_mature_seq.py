...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interval.hairpin_seq'
        db.add_column(u'loq_interval', 'hairpin_seq',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)

        # Adding field 'Interval.mature_seq'
        db.add_column(u'loq_interval', 'mature_seq',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interval.hairpin_seq'
        db.delete_column(u'loq_interval', 'hairpin_seq')

        # Deleting field 'Interval.mature_seq'
        db.delete_column(u'loq_interval', 'mature_seq')
