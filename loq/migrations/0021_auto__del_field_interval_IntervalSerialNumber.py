...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Interval.IntervalSerialNumber'
        db.delete_column(u'loq_interval', 'IntervalSerialNumber')


    def backwards(self, orm):
        # Adding field 'Interval.IntervalSerialNumber'
        db.add_column(u'loq_interval', 'IntervalSerialNumber',
                      self.gf('django.db.models.fields.IntegerField')(max_length=45, null=True),
                      keep_default=False)
