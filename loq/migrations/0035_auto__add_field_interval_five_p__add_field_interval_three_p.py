...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interval.five_p'
        db.add_column(u'loq_interval', 'five_p',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45, blank=True),
                      keep_default=False)

        # Adding field 'Interval.three_p'
        db.add_column(u'loq_interval', 'three_p',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interval.five_p'
        db.delete_column(u'loq_interval', 'five_p')

        # Deleting field 'Interval.three_p'
        db.delete_column(u'loq_interval', 'three_p')
