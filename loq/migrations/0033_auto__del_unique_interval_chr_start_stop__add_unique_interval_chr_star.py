...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Interval', fields ['chr', 'start', 'stop', 'mapped_strand']
        db.create_unique(u'loq_interval', ['chr', 'start', 'stop', 'mapped_strand'])


    def backwards(self, orm):
        # Removing unique constraint on 'Interval', fields ['chr', 'start', 'stop', 'mapped_strand']
        db.delete_unique(u'loq_interval', ['chr', 'start', 'stop', 'mapped_strand'])
