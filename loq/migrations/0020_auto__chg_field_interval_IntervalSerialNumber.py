...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'loq_interval', 'IntervalSerialNumber', self.gf('django.db.models.fields.IntegerField')(max_length=45, null=True))
        # Removing index on 'Interval', fields ['IntervalSerialNumber']
        db.delete_index(u'loq_interval', ['IntervalSerialNumber'])


    def backwards(self, orm):
        # Adding index on 'Interval', fields ['IntervalSerialNumber']
        db.create_index(u'loq_interval', ['IntervalSerialNumber'])
